...
- Refinitiv for market data API
- Open-source technical analysis library (`ta`)
- Statistical arbitrage research community

---

**Disclaimer**: This software is for educational and research purposes only. It is not financial advice. Always perform thorough due diligence before deploying any trading strategy with real capital.
